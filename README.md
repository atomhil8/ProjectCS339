...
### Build Instructions:
1. Make sure you have g++ set up and that it compiles C++ at version 11 or later
...
> Note that inputFileName is the full name (extention included) of the assembly file that you wish to run and debugMode is set to true when the argument "true" is passed.
